...
class SchedulingEngine {
  ...
  static DateTime calculateRevisionBoundary(DateTime examDate,
      {int revisionDays = 12}) {
    ...
    sortedTasks.sort((a, b) {
      if (a.priority != b.priority) {
        return a.priority.index
            .compareTo(b.priority.index); // Enum index 0 is high
      }
  ...
  static List<Schedule> generateAlternatives(Schedule baseSchedule) {
    ...
    return [
      ...
      Schedule(
          ...
          studentId: baseSchedule.studentId,
          date: baseSchedule.date,
          blocks: baseSchedule.blocks.skip(1).toList(),
          version: 2), // Dropped first task
    ];
  }
}
